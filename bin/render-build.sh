...
# サンプルデータを本番データとして作成するには、bin/render-build.shファイルをリスト 10.65のように変更しましょう。
...
# Am sure there is no case where we want to set sample data in production... Thus, skip it!!!
